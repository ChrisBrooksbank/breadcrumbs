...
1. **Explore & return** — Walk somewhere new, then retrace your exact steps back to the start. *This is the primary scenario. Build this first.*
2. **Record & repeat** — Save favourite routes (dog walks, runs) and follow them again later. *Secondary — add after core is solid.*
3. **Safety net** — Always-on recording so you can retrace if you get lost. *Supported by auto-record on open.*
4. ~~Share routes~~ — *Not a priority. Excluded by user.*
